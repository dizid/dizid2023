...
<template>
  <div class="apps">
    <h1>Portfolio</h1>
    <p>Example of websites, apps and tools i made in the past 10 years:</p>
    <div class="flex">
      <div
        class="purpleurls"
        ...
        :key="project.id"
      >
        <p v-if="project.fields.URL">
          <a :href="project.fields.URL">{{ project.fields.Title }}</a>
        </p>
        <p v-else>{{ project.fields.Title }}</p>
        <p>
          <img
            :src="project.fields.Image[0].url"
            :alt="project.fields.slug"
            width="250"
          />
        </p>
      </div>
